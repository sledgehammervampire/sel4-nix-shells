{ lib, stdenv, fetchurl, coreutils, nettools, java, polyml, z3, veriT, vampire, eprover-ho, rlwrap, makeDesktopItem, fetchhg, runCommand }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ ml_home z3 veriT vampire eprover-ho ]
